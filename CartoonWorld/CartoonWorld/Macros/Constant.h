...
#define SCREEN_CONTENT_HEITH SCREEN_HEIGHT - NAVIGATIONBAR_HEIGHT

// 控件
#define STATUSBAR_HEIGHT (iPhoneX ? 44:20)     // 状态栏高度
#define NAVIGATIONBAR_HEIGHT (iPhoneX ? 88:64) // navigationBar高度(包含了statusBar)
...
#define HEIGHT_HEADER_COMICDETAIL  (VERTICAL_CELL_HEIGHT - LABEL_HEIGHT + 5*TOP_BOTTOM) + NAVIGATIONBAR_HEIGHT // 漫画详情头
