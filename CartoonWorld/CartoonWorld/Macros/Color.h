...
#define COLOR_PINK          [RGBColor colorWithHexString:@"#EE6AA7"] // 红色
...
#define TEXT_COLOR          [UIColor colorWithWhite:0.3 alpha:1.0]   // 默认字体颜色
#define TEXT_GRAD_COLOR     [RGBColor colorWithHexString:@"#828282"] // 灰色字体颜色
